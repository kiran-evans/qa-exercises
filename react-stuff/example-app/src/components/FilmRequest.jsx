...
const FilmRequest = () => {
    ...
    return (
        <>
            ...
            <p />
            {(film.Response !== 'False') ? <Film title={film.Title} year={film.Year} director={film.Director} actors={film.Actors} plot={film.Plot} poster={film.Poster} /> : <p>No film found</p>}
        </>
    );
};
